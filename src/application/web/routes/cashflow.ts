...
export async function handleCashflow(_req: Request, url: URL): Promise<Response> {
...
export async function handleCashflowProjetado(_req: Request, _url: URL): Promise<Response> {

...
import type { MonthInsightRow } from "../db/BunPgAdapter.ts";
...
${notableItems.length > 0 ? notableItems.join("\n") : "Nenhuma transação com anomalia alta detectada"}`
      ),
    ],
  });
